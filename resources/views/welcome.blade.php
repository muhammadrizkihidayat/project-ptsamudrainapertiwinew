        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-28">
                <div class="flex items-center">
                    <img src="{{ asset('images/logo.png') }}" alt="Logo SIP" class="h-24 w-auto mr-4">
                    <div>
                ...
                <div class="flex items-center space-x-4">
                    @auth
                        <a href="{{ route('dashboard') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-semibold shadow-lg shadow-blue-600/35 transition">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="text-slate-300 hover:text-white text-sm font-semibold transition">Masuk</a>
                        <a href="{{ route('register') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-semibold shadow-lg shadow-blue-600/35 transition">Daftar Akun</a>
                    @endauth
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                <div class="lg:col-span-7 space-y-6 text-center lg:text-left">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="{{ route('register') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-bold shadow-xl shadow-blue-600/30 transition text-center text-base">
                ...
                <div class="lg:col-span-5 relative hidden lg:block">
                    <div class="relative rounded-2xl overflow-hidden border-2 border-slate-700 shadow-[0_0_40px_rgba(59,130,246,0.3)] group hover:scale-[1.02] transition-transform duration-500">
                        <img src="{{ asset('images/hero.jpg') }}" class="w-full h-auto object-contain rounded-2xl group-hover:scale-105 transition-transform duration-700 bg-slate-800" alt="Tim PT Samudra Ina Pertiwi">
