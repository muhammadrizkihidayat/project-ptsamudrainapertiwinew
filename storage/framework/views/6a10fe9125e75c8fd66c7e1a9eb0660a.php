...
<body class="h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950">
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center">
        ...
        <p class="text-sm text-slate-400 mt-2">
            Sudah memiliki akun? 
            <a href="<?php echo e(route('login')); ?>" class="font-semibold text-blue-500 hover:text-blue-400 transition">Masuk di sini</a>
        </p>
    </div>
...
<?php /**PATH C:\xampp\htdocs\ptsamudrainapertiwi_sip\resources\views/auth/register.blade.php ENDPATH**/ ?>